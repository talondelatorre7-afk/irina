(() => {
    ...
    const CONFIG = {
        ...
        CLASSES: {
            active: "cs-active",
            menuOpen: "cs-open",
            scroll: "scroll", // Added scroll class reference
        },
    };
    ...
    // Event Management
    const eventManager = {
        // --- ADDED: Scroll Handler for Transparent Header ---
        handleScroll() {
            const scroll = document.documentElement.scrollTop;
            if (scroll >= 50) {
                elements.body.classList.add(CONFIG.CLASSES.scroll);
            } else {
                elements.body.classList.remove(CONFIG.CLASSES.scroll);
            }
        },
    ...
    const init = {
        ...
        eventListeners() {
            ...
            // --- ADDED: Attach the scroll listener ---
            document.addEventListener("scroll", eventManager.handleScroll);
